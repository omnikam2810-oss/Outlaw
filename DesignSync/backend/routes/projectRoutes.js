...
const { getProjects, createProject, getProject, updateProjectStatus, addProjectFeature, updateProjectFeature, deleteProjectFeature, deleteProject } = require('../controllers/projectController');
...
router.post('/:id/features', authorize('admin'), addProjectFeature);
router.put('/:id/features/:featureId', authorize('admin', 'designer', 'enterprise_client'), updateProjectFeature);
router.delete('/:id/features/:featureId', authorize('admin'), deleteProjectFeature);
